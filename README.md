...
# Развертывание микросервисной архитектуры Telegram-бота и веб-лендинга с использованием Docker Compose и автоматизацией выпуска сертификатов Let's Encrypt
